...
<div class="p-6 space-y-6" x-data="{
    ...
    applyFilters() {
        ...
        window.location.href = '{{ route('manager.menus') }}?' + params.toString();
    },
    editMenu(menu) {
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-[#2c241b]/50 transition-colors group">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('manager.menus.edit', $menu->id) }}" class="p-1.5 hover:bg-gray-100 dark:hover:bg-[#2c241b] rounded text-[#5c4d40] dark:text-[#a89c92] hover:text-[#181411] dark:hover:text-white transition-colors" title="Edit">
